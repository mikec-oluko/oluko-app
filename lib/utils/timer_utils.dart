...
class TimerUtils {
  ...
  static const double _watchHeight = OlukoNeumorphism.isNeumorphismDesign
      ? _olukoNeumorphicWatchProgressSize
      : _olukoWatchProgressSize;
  static const double _watchWidth = OlukoNeumorphism.isNeumorphismDesign
      ? _olukoNeumorphicWatchProgressSize
      : _olukoWatchProgressSize;
  static const double _roundWatchWidthWithKeyboard =
      OlukoNeumorphism.isNeumorphismDesign
          ? _olukoNeumorphicWatchSize
          : _olukoWatchFullSize;
  static const double _progressIndicatorStroke =
      OlukoNeumorphism.isNeumorphismDesign ? 2 : 4;
  static const Color getGreenOrCoral = OlukoNeumorphism.isNeumorphismDesign
      ? OlukoNeumorphismColors.olukoNeumorphicGreenWatchColor
      : OlukoColors.coral;
  static const Color getGreenOrSkyBlue = OlukoNeumorphism.isNeumorphismDesign
      ? OlukoNeumorphismColors.olukoNeumorphicGreenWatchColor
      : OlukoColors.skyblue;
  static const Color backgroundColor = OlukoNeumorphism.isNeumorphismDesign
...
//CLOCKS
      ...
      Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text(OlukoLocalizations.get(context, 'round') + "  ",
              textAlign: TextAlign.center,
              style:
                  OlukoFonts.olukoSmallFont(custoFontWeight: FontWeight.bold)),
  ...
  static Widget roundsTimer(int totalRounds, int currentRound,
      ...
      Container(
          ...
          child: getSegmentedProgressBar(
              totalRounds.toDouble() > 0 ? totalRounds.toDouble() : 1,
              currentRound.toDouble() <= totalRounds.toDouble()
                  ? currentRound.toDouble()
                  : 1));

  static Widget getSegmentedProgressBar(
      double totalRounds, double currentRound) {
    if (totalRounds < _maxStepsForSegmentedClock) {
      return SegmentedIndeterminateProgressbar(
        ...
        progress: currentRound.toDouble() <= totalRounds.toDouble()
            ? currentRound.toDouble()
            : 1,
      );
    } else {
      return Stack(fit: StackFit.expand, children: [
        ...
        Padding(
          ...
          child: CircularProgressIndicator(
              strokeWidth: 10,
              value: getProgressAscending(
                  totalRounds.toInt(), currentRound.toInt()),
              ...
              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text(duration,
                    ...
                    style: TextStyle(
                        fontFamily: 'Gilroy',
                        fontSize:
                            OlukoNeumorphism.isNeumorphismDesign ? 35 : 25,
                        fontWeight: FontWeight.bold,
                        color: Colors.white)),
                if (counter != null)
                  OlukoNeumorphism.isNeumorphismDesign
                      ? neumorphicContentWithPadding(
                          context,
                          getTextLabel(
                              OlukoLocalizations.get(context, 'countYour') +
                                  counter,
                              context,
                              true))
                      : getTextLabel(
                  ...
                  SizedBox(height: 5),
                if (bothSide)
                  getTextLabel(OlukoLocalizations.get(context, 'rememberTo'),
                      context, true)
                else
                  const SizedBox.shrink(),
                if (bothSide)
                  getTextLabel(OlukoLocalizations.get(context, 'switchSide'),
                      context, false)
                else
                  SizedBox(),
                    ...
                    children: [
                      ...
                      Text(OlukoLocalizations.get(context, 'completed'),
                          ...
                          style: OlukoFonts.olukoSuperBigFont(
                              custoFontWeight: FontWeight.bold,
                              customColor: OlukoNeumorphism.isNeumorphismDesign
                                  ? OlukoNeumorphismColors
                                      .olukoNeumorphicGreenWatchColor
                                  : Colors.white)),
                      const SizedBox(height: 8),
                      if (rounds != null)
                        Text(
  ...
  static Widget restTimer(Widget addCounterValue, double progressValue,
        ...
        children: [
          ...
          SizedBox(
            ...
            child: AspectRatio(
                ...
                child: CircularProgressIndicator(
                    strokeWidth: _progressIndicatorStroke,
                    value: OlukoNeumorphism.isNeumorphismDesign
                        ? 1
                        : progressValue,
                    color: getGreenOrSkyBlue,
                    backgroundColor: backgroundColor)),
          ...
          if (OlukoNeumorphism.isNeumorphismDesign && addCounterValue != null)
            Positioned(
                bottom: ScreenUtils.smallScreen(context)
                ...
                child: duration != null
                    ? Text(duration,
                        ...
                        style: TextStyle(
                            fontSize:
                                OlukoNeumorphism.isNeumorphismDesign ? 20 : 15,
                            fontWeight: FontWeight.bold,
                            color: Colors.white,
                            fontFamily: 'Gilroy'))
                    : SizedBox())
                ...
                child: Stack(alignment: Alignment.center, children: [
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            height:
                                OlukoNeumorphism.isNeumorphismDesign ? 20 : 5),
                        ...
                        bothSide
                            ? getTextLabel(
                                OlukoLocalizations.get(context, 'rememberTo'),
                                context,
                                true)
                            : SizedBox(),
                        bothSide
                            ? getTextLabel(
                                OlukoLocalizations.get(context, 'switchSide'),
                                context,
                                false)
                            : SizedBox()
                      ])
  ...
  static Widget AMRAPTimer(double progressValue, String duration,
      BuildContext context, Function() onTap, int roundsValue) {
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Text(OlukoLocalizations.get(context, 'tapHere'),
                            ...
                            style: TextStyle(
                                fontFamily: 'Gilroy',
                                fontSize: OlukoNeumorphism.isNeumorphismDesign
                                    ? 42
                                    : 26,
                                fontWeight: FontWeight.bold,
                                color: OlukoNeumorphism.isNeumorphismDesign
  ...
  static Widget finalTimer(
      InitialTimerType type, int totalTime, int countDown, BuildContext context,
      [int round]) {
    var r = ScreenUtils.height(context);
    return Stack(alignment: Alignment.center, children: [
      SizedBox(
        width: ScreenUtils.smallScreen(context)
            ? ScreenUtils.height(context) * 0.275
...
//HELPER METHODS
  ...
  static Column neumorphicContentWithPadding(
      BuildContext context, Widget childrenContent) {
    return Column(
      children: [
        Padding(
  ...
  static startCountdown(WorkoutType workoutType, BuildContext context,
    ...
    Navigator.pushNamed(context, routeLabels[RouteEnum.segmentClocks],
        arguments: arguments);
    //});
  }
}
