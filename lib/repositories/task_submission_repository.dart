...
class TaskSubmissionRepository {
  ...
  static updateTaskSubmissionPrivacity(
      AssessmentAssignment assessmentA, String id, bool isPublic) async {
    DocumentReference reference = projectReference
        .collection('assessmentAssignments')
        .doc(assessmentA.id)
        .collection('taskSubmissions')
  ...
  static Future<List<TaskSubmission>> getTaskSubmissions(
