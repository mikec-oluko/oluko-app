...
class _InsideClassesState extends State<InsideClass> {
  ...
  Widget classMovementSection() {
    _classMovements = ClassService.getClassSegmentMovements(ClassService.getClassMovements(_class), _movements);
    ...
    return ListView(children: [
      Padding(
          ...
          child: OverlayVideoPreview(
              video: _class.video,
              showBackButton: true,
              bottomWidgets: [CourseInfoSection(peopleQty: 50, audioMessageQty: 1, image: widget.courseEnrollment.course.image)])),
      Padding(
