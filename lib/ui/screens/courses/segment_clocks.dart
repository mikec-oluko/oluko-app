  ...
  */
  ...
  Widget taskSectionWithoutRecording(String currentTask, String nextTask) {
    if (timerEntries[timerTaskIndex].label == null) {
      return Padding(padding: EdgeInsets.only(top: 25), child: Column(children: getJoinedLabel()));
    } else {
      return Padding(
  ...
  List<Widget> getJoinedLabel() {
    ...
    timerEntries[timerTaskIndex].labels.forEach((label) {
      labelWidgets
          .add(Text(label, style: TextStyle(fontSize: 20, color: OlukoColors.white, fontWeight: FontWeight.w300)));
...
//App bar icons
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
              ...
              child: workoutType == WorkoutType.segment ? _feedbackCard() : _shareCard()),
        ],
      ),
    );
  }
  ...
  Widget _shareCard() {
    return Container(
      decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: OlukoColors.listGrayColor),
      child: Padding(
        padding: const EdgeInsets.all(8.0),
        child: Column(
                                  ...
                                  child: Column(
                                    children: [
                                      ElevatedButton(
                                        ...
                                        style:
                                            ElevatedButton.styleFrom(minimumSize: Size(50, 50), primary: Colors.white),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text('Stories', style: OlukoFonts.olukoMediumFont()),
                                      )
                                    ],
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text('To Coach', style: OlukoFonts.olukoMediumFont()),
                                      )
                                    ],
                                  ),
                                ),
