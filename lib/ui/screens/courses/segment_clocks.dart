...
class _SegmentClocksState extends State<SegmentClocks> {
  ...
  Future<void> callBlocToCreateStory(BuildContext context, SegmentSubmission segmentSubmission) =>
  ...
  _saveSegmentRound(TimerEntry timerEntry) async {
    if (isSegmentWithRecording()) {
      ...
      BlocProvider.of<SegmentSubmissionBloc>(context)
        ..create(_user, widget.courseEnrollment, widget.segments[widget.segmentIndex], video.path, _coachRequest);
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
              ...
              child: widget.workoutType == WorkoutType.segment || shareDone ? FeedbackCard() : ShareCard(createStory: _createStory)),
        ],
      ),
    );
  }
