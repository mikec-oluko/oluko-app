...
class SignUpNeumorphicPage extends StatefulWidget {
  SignUpNeumorphicPage({Key key}) : super(key: key);

  @override
  _SignUpNeumorphicPageState createState() => _SignUpNeumorphicPageState();
}

class _SignUpNeumorphicPageState extends State<SignUpNeumorphicPage> {
  @override
