...
class EnrollmentSegment {
  ...
  EnrollmentSegment({this.id, this.reference, this.name, this.completedAt, this.sections, this.challengeImage, this.is_challenge});
  ...
  Map<String, dynamic> toJson() =>
      {'id': id, 'reference': reference, 'name': name, 'completed_at': completedAt, 'is_challenge': is_challenge, 'challenge_image': challengeImage, 'sections': sections == null ? null : List<dynamic>.from(sections.map((section) => section.toJson()))};
}
