...
class EnrollmentSegment {
  ...
  EnrollmentSegment(
      {this.id, this.reference, this.name, this.completedAt, this.sections, this.challengeImage, this.isChallenge});
  ...
  factory EnrollmentSegment.fromJson(Map<String, dynamic> json) {
    return EnrollmentSegment(
        ...
        sections: json['sections'] == null
            ? null
            : List<EnrollmentSection>.from((json['sections'] as Iterable)
                .map((section) => EnrollmentSection.fromJson(section as Map<String, dynamic>))));
  }
